        ...
        with open(csv_file, 'r') as file:
            ...
            for row in csv_data:
                ...
                if all(value is not None for value in row):
                    ...
                    values = (attributes[0], attributes[1], attributes[2], attributes[3], attributes[4], attributes[5], attributes[6])  # Aquí asume que los valores están en la columna 1 y columna 2
